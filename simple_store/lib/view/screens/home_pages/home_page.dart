            ...
            return BlocListener<CategoryBloc,CategoryState>(
              listener: (context, state) {
                if (state is CategoryLoaded){
                  ...
                  BlocProvider.of<ProductBloc>(context).add(ProductReload(state.selectedCategory));
                }
              },
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: state.products[index].active ? () {
                                      BlocProvider.of<CartBloc>(context)..add(CartItemAdded(CartItem(item: state.products[index],numOfItem: 1)));
                                    } : null,
